...
public class MemberController {
    ...
    public ApiResponse<MemberResponseDto.MyPageMemberDto> getMemberForMyPage(@PathVariable("memberId") Long memberId) {
        Member memberWithTicketsAndMemberTeamsByMemberId = memberQueryService.findMemberWithTicketsAndMemberTeamsByMemberId(memberId);
